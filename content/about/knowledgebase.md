...
It's not supposed to be public, and if you're reading it, you were not supposed to have access.
Opps!
...
## Life Timeline Summery ##
  ...
  * Adolescence
    * Born in Canton, but raised in the forested hills of East Sparta
    * Paternal Grandparents mostly raised me before my grandmother died when I was 5
    * Maternal Grandfather used to physically abuse me, which explains why I grew up to be quite, "because I was too loud"
    * Mother was verbally abusive
    * Father was emotionally unavailable
    * Once was diagnosed with ADHD, but that was something to be ashamed of, so my mother abandoned treatment
    * Was always depressed in childhood
    * Always in gifted or advanced classes, but generally uninterested or motivated to do schoolwork outside of school
    * Incredibly high expectations are set of me.
    * I'm a gifted artist in grade school, and then quite entirely from art in 8th grade, after being pushed to make this my career.
    * Learned programming and web design in middle school.
    * Decide I am going to choose to make that my career.
    * Took my first software engineering internship at the age of 15.
    * In highschool was involved with Boy Scouts of America, Tennis, Business Professionals of America, and Robotics.
  * 2008
    * Started my first LLC, BlaherTech, commissioning websites for small businesses.
    * Impregnated my highschool sweetheart while in highschool, which lead to be giving up scholarship opportunities
  * 2009
    * Graduated highschool from Canton South.
    * Began working at The Karcher Group as a website fullstack programmer.
  * 2010
    * Moved out from my parents in with my girlfriend and baby boy, Marcus.
    * Sold my first business' clients and join the workforce as a Software Engineer.
  * 2011
    * Then-fiancee cheated on me and broke off our engagement.
    * Began working at BrainHost, an work-from-home affiliate marketing offer, that provide a website for commissions to affiliates sales funnels.
  * 2012
    * Bought my first house in North Canton
    * Begin consulting for several companies, including Davey Tree, FirstMerit, Avesta Corp, ListMedia, MP Biomedicals, and some government sectors.
    * Began working at Mongoose Metrics.
    * Met AJ and started dating
    * AJ and I adopt Izzy, a Border Collie dog, together.
  * 2013
    * AJ informs me she is pregnant, who later we find out is a girl. Whom we decided to name Audrey.
    * Solely developed the product, Call Insights, which was a first of it's kind to use NSA-subleased voice transcription technology to transcribe high volume of call-center recordings to act as a Business Intelligent tool to then use AI to provide analytics and KPIs for the customer support experience of calls.
    * Call Insights is what leads to the multi-million dollar sale of Mongoose Metrics to a Chicago company, IfByPhone.
    * Engaged to AJ.
    * AJ is kill in a car accident.
  ...
  * 2014
    ...
    * IfByPhone rebrand to DialogTech, and I shortly part after.
    * I begin working at Performance Administration Corporation, leading the transition for their monolithic environment hosted locally to a scalable service on Amazon Web Services.
  * 2015
  ...
  * 2016
    * I adopt Princess, a black and white long haired domestic cat.
    * I start playing tennis again.
  * 2017
    * Buy my second house in Massillon
    * Met Gertrude
    * Leave Performance Administration Corporation to become Advolve Media's CTO.
  * 2018
    * I start a wrist watch company online, Waltham & Westgate.
    * Start working for a prior consulting company I was with before, Avesta Corporation, to lead transition to move to a scalable product in order to be acquired by OnShift.
  * 2019
    * End Waltham & Westgate due to low profit margins, that was not worth my time.
    * I start cycling again on an e-bike.
    * Gertrude and I would start an affair, where I fell in love for the third time, and start to feel emotions again
    * Our intimate relationship reminds me too much of AJ
  * 2020
    ...
    * I seemingly and intently vanish from the public's eye
    * I lose 60lbs in the first four months, and 100lbs in the first year
    * I make a theatrical resurfacing, drastically physically changed
    * I have found happiness again
    * I start sleeping around far too much over the next year, with the new-found attention I'm getting.
    * Gertude reaches out, and we have an argument.
    * I jokingly threaten to send her 30 fruitcakes if she doesn't stop this depressed behavior.
    * Cops are called and a no contact order is put in place
  * 2021
    * Gertude reaches out to me, seemingly wanting to amend things, and we sleep together while under a no contact order.
  ...
  * 2022
    ...
    * I find out too late that this charge can't be expunged, and it's too late to appeal it.
    * I start to lose everything, from being unemployed and making it impossible to find work with my record.
  ...
  * 2024
    ...
    * The driver fled and is never caught
    * This leads to a lot of lasting pain and inability for me to play tennis pain-free
    * While in the trauma ER, they tell me I have a tumor and should get it checked out. I forget this part.
  * 2025
    * I have to get a restraining order against one of Gertude's friends, who keeps harassing me.
    * I become involved in the Massillon Arts Community Council.
