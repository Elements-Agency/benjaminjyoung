...
{{< row-start >}}
    {{< preview col="6" painting="/artwork/winter-barn-i/" >}}
    {{< preview col="6" painting="/artwork/winter-birch-i/" >}}
{{< row-end >}}
...
## Inspiration from the Coast: Delaware Trip ##
...
{{< img span="image fit" src="beach.jpg" alt="Beach in Delaware" title="Winter Beach Walk" >}}
...
{{< img span="image fit" src="brewtifully.jpg" alt="Brewtifully Exhibit" title="Brewtifully Exhibit" >}}
...
{{< row-start >}}
    {{< img col="3" src="wip1.jpg" alt="" title="" >}}
    {{< img col="3" src="wip2.jpg" alt="" title="" >}}
    {{< img col="3" src="wip3.jpg" alt="" title="" >}}
    {{< img col="3" src="wip4.jpg" alt="" title="" >}}
    {{< img col="3" src="wip5.jpg" alt="" title="" >}}
    {{< img col="3" src="wip6.jpg" alt="" title="" >}}
    {{< img col="3" src="wip7.jpg" alt="" title="" >}}
    {{< img col="3" src="wip8.jpg" alt="" title="" >}}
{{< row-end >}}
...
{{< preview style="right" painting="/story/howards-hills/" full="true" caption="My father in Howard's Hills" >}}
...
{{< row-start >}}
    {{< preview col="4" painting="/story/in-the-dark/" >}}
