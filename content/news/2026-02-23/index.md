...
{{< row-start >}}
    {{< img col="6" src="preop.jpg" alt="Pre-Operation Thumbs-up" title="Pre-Operation" >}}
    {{< img col="6" src="postop.jpg" alt="Post-Operation Thumbs-up" title="Post-Operation" >}}
{{< row-end >}}
...
{{< row-start >}}
    {{< preview col="6" painting="/artwork/winter-pasture-i/" >}}
{{< row-end >}}
...
## A Personal Gift: Cherry Blossoms for My Caretaker ##
...
{{< img class="image fit" src="cherryblossoms.jpg" alt="Incomplete Cherry Blossom Watercolor Painting" title="Cherry Blossoms" >}}
...
Some paintings are created for exhibition.
Some are created for collectors.
And some are created simply to say thank you.
...
{{< row-start >}}
    {{< img col="6" src="mugshotsketch.jpg" alt="Jerry Lee Lewis Mugshot Sketch" title="Sketch" >}}
    {{< img col="6" src="mugshot.jpg" alt="Jerry Lee Lewis Mugshot Watercolor Painting" title="Incomplete Watercolor Painting" >}}
{{< row-end >}}
...
{{< row-start >}}
    {{< img col="6" src="catsketch.jpg" alt="Cat Sketch" title="Sketch" >}}
    {{< img col="6" src="cat.jpg" alt="Cat Painting" title="Incomplete Tempera Painting" >}}
{{< row-end >}}
...
I’m honored to share several upcoming and current exhibitions:
  ...
  * The Ohio Watercolor Society Traveling Exhibit is now opening at the Marathon Center for the Performing Arts in Findlay, Ohio. Featuring [Avalanche Lilies](/story/avalanche-lilies).
  * In March, a limited reproduction of [Okay Now](/story/okay-now) will be displayed at the Kirk Schuring Center for the Stark County Minority Business Association opening.
  * I was recently juried into the 22nd Annual Bryn Du Art Show, hosted at Bryn Du Mansion in Granville, Ohio, for my painting [Corporate Contempt](/story/corporate-contempt). Being selected for this exhibition is a meaningful milestone.
